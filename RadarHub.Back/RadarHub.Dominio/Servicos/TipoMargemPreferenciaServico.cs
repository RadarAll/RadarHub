...
{
    public class TipoMargemPreferenciaServico : ServicoImportacaoTerceiro<TipoMargemPreferencia>
    {
        private readonly Pncp _pncp;
        private readonly ITransacao _transacao;

        public TipoMargemPreferenciaServico(
            IRepositorioImportacaoTerceiro<TipoMargemPreferencia> repositorio,
        ...
        public async Task<bool> ImportarAsync()
        {
            try
            {
                ...
                {
                    _mensagens.Adicionar("Nenhum tipo de margem preferência encontrado para importação.", TipoMensagem.Aviso);
                ...
                _mensagens.Adicionar(
                    $"Importação concluída. {novas} novos tipos de margens preferência adicionados e {atualizadas} atualizados.",
