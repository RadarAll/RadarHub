...
{
    public class PoderServico : ServicoImportacaoTerceiro<Poder>
    {
        ...
        public async Task<bool> ImportarAsync()
        {
            try
            {
                ...
                {
                    _mensagens.Adicionar("Nenhum poder encontrado para importação.", TipoMensagem.Aviso);
                    return true;
                }
                ...
                _mensagens.Adicionar(
                    $"Importação concluída. {novas} novos poderes adicionados e {atualizadas} atualizados.",
